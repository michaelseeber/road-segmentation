# THIS FILE CONSTRUCTS A U-Net like network with dilated convolutions in the bottleneck, uses BaclancedCE + Lovasz loss, data augmentation, test time augmentation, prediction on 9 images patches
