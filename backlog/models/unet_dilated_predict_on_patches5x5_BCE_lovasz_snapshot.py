# THIS FILE LOADS A network, uses lovasz hinge loss, data augmentation, test time augmentation, prediction on 25 images patches
...
def main():
    ...
    snapshot_ensemble = SnapshotEnsemble(n_models=NUM_SNAPSHOTS, n_epochs_per_model=EPOCHS / NUM_SNAPSHOTS, lr_max=0.1, test_dataset=test_dataset)
