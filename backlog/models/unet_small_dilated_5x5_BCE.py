# THIS FILE CONSTRUCTS A smaller U-Net like network with dilated convolutions in the bottleneck, uses BaclancedCE data augmentation, test time augmentation, prediction on 25 images patches
