...
def main():
    ...
    #### Load trained FCN model ####
    #model = tf.keras.models.load_model('saved_models/model_2020-07-20_18:44.h5', compile=False)
    #model = tf.keras.models.load_model('saved_models/model_2020-07-22_19:50.h5', compile=False)#BCE (CORRECT MASK)
    #model = tf.keras.models.load_model('saved_models/model_2020-07-23_01:00.h5', compile=False)#BCE + color augmentation (CORRECT MASK)
    #model = tf.keras.models.load_model('saved_models/model_2020-07-23_18:10.h5', compile=False)#small BCE + color augmentation (CORRECT MASK)
    model = tf.keras.models.load_model('saved_models/model_2020-07-27_03:54.h5', compile=False)#BCE + color augmentation + random erasure(CORRECT MASK)
