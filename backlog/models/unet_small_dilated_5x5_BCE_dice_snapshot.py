...
def main():
    ...
    snapshot_ensemble = SnapshotEnsemble_with_probabilities(n_models=NUM_SNAPSHOTS, n_epochs_per_model=EPOCHS / NUM_SNAPSHOTS, lr_max=0.01, test_dataset=test_dataset)
