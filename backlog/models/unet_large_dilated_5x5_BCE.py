# THIS FILE CONSTRUCTS A U-Net like network with dilated convolutions in the bottleneck, more filters (=more parameters), uses BaclancedCE data augmentation, test time augmentation, prediction on 25 images patches
...
def main():
    ...
    conv2 = tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same') (pooling1)
    ...
    conv3 = tf.keras.layers.Conv2D(128, (3, 3), activation='relu', padding='same') (pooling2)
    ...
    conv4 = tf.keras.layers.Conv2D(256, (3, 3), activation='relu', padding='same') (pooling3)
    ...
    #conv5 = tf.keras.layers.BatchNormalization() (conv5)
    conv5_1 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=1, padding='same') (pooling4)
    conv5_2 = tf.keras.layers.BatchNormalization() (conv5_1)
    conv5_2 = tf.keras.layers.Dropout(0.05) (conv5_2)
    conv5_2 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=2, padding='same') (conv5_2)
    conv5_4 = tf.keras.layers.BatchNormalization() (conv5_2)
    conv5_4 = tf.keras.layers.Dropout(0.05) (conv5_4)
    conv5_4 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=4, padding='same') (conv5_4)
    conv5_8 = tf.keras.layers.BatchNormalization() (conv5_4)
    conv5_8 = tf.keras.layers.Dropout(0.05) (conv5_8)
    conv5_8 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=8, padding='same') (conv5_8)
    conv5_16 = tf.keras.layers.BatchNormalization() (conv5_8)
    conv5_16 = tf.keras.layers.Dropout(0.05) (conv5_16)
    conv5_16 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=16, padding='same') (conv5_16)
    conv5_32 = tf.keras.layers.BatchNormalization() (conv5_16)
    conv5_32 = tf.keras.layers.Dropout(0.05) (conv5_32)
    conv5_32 = tf.keras.layers.Conv2D(512, (3, 3), activation='relu', dilation_rate=32, padding='same') (conv5_32)
    ...
    upsample6 = tf.keras.layers.Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same') (conv5_sum)
    upsample6 = tf.keras.layers.concatenate([upsample6, conv4])
    conv6 = tf.keras.layers.Conv2D(256, (3, 3), activation='relu', padding='same') (upsample6)
    conv6 = tf.keras.layers.BatchNormalization() (conv6)
    #conv6 = tf.keras.layers.Dropout(0.2) (conv6)
    conv6 = tf.keras.layers.Conv2D(256, (3, 3), activation='relu', padding='same') (conv6)
    conv6 = tf.keras.layers.BatchNormalization() (conv6)
    
    upsample7 = tf.keras.layers.Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same') (conv6)
    upsample7 = tf.keras.layers.concatenate([upsample7, conv3])
    conv7 = tf.keras.layers.Conv2D(128, (3, 3), activation='relu', padding='same') (upsample7)
    conv7 = tf.keras.layers.BatchNormalization() (conv7)
    #conv7 = tf.keras.layers.Dropout(0.2) (conv7)
    conv7 = tf.keras.layers.Conv2D(128, (3, 3), activation='relu', padding='same') (conv7)
    conv7 = tf.keras.layers.BatchNormalization() (conv7)
    
    upsample8 = tf.keras.layers.Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same') (conv7)
    upsample8 = tf.keras.layers.concatenate([upsample8, conv2])
    conv8 = tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same') (upsample8)
    conv8 = tf.keras.layers.BatchNormalization() (conv8)
    #conv8 = tf.keras.layers.Dropout(0.1) (conv8)
    conv8 = tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same') (conv8)
    conv8 = tf.keras.layers.BatchNormalization() (conv8)
    
    upsample9 = tf.keras.layers.Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same') (conv8)
    upsample9 = tf.keras.layers.concatenate([upsample9, conv1], axis=3)
    conv9 = tf.keras.layers.Conv2D(32, (3, 3), activation='relu', padding='same') (upsample9)
